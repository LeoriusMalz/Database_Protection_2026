...
| Фамилия            |                                    Задача                                     |
|:-------------------|:-----------------------------------------------------------------------------:|
| 1. Мальцев Л. А.   |                  2. Теоретические основы безопасности в СУБД                  |
| 2. Наумкин В. П.   |                        8. Распознавание вторжений в БД                        |
| 3. Стеценко Я. И.  |               4. Механизмы обеспечения конфиденциальности СУБД                |
| 4. Островной К. А. |                  6. Защита данных в распределенных системах                   |
| 5. Гараев К. Р.    |                5. Механизмы, поддерживающие высокую готовность                |
| 6. Хабалов П. В.   |                      7. Безопасность в статистических БД                      |
| 7. Гришаев Г. П.   |                   3. Механизмы обеспечения целостности СУБД                   |
| 8. Трубников А. А. |                       9. Проектирование безопасности БД                       |
...
|3. Вакуленков Д. В.| 7. Безопасность в статистических БД                    |
...
|7. Лаврентьев А. В.| 1.1 - 1.6 + 1.8 - 1.9 Концепция безопасности БД        |
